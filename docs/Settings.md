...
| nav_multi_waypoint_mission_index | 1 |  | 9 | Index of mission selected from multi mission WP file. 1 is the first WP mission in the file. If index exceeds number of missions in file then no mission is loaded. |
...
| osd_sidebar_height | 3 | 0 | 5 | Height of sidebars in characters. 0 leaves only the horizon indicator arrows. (Not for pixel OSD) |
