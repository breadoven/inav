...
typedef struct batteryProfile_s {
    ...
    uint16_t failsafe_throttle;             // Throttle level used for landing - between 1000..2000 (pwm pulse width for slightly below hover). center throttle = 1500.
    ...
    struct {
        ...
        struct {
            ...
            uint16_t auto_speed_level_min_thr;  // CR164
