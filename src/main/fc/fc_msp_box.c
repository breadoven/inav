...
static const box_t boxes[CHECKBOX_ITEM_COUNT + 1] = {
    ...
    { .boxId = BOXMULTISELECT,      .boxName = "MULTI SELECT",      .permanentId = 60 },    // CR88
...
void initActiveBoxIds(void)
{
    ...
    ADD_ACTIVE_BOX(BOXMULTISELECT); // CR88
...
#endif
    CHECK_ACTIVE_BOX(IS_ENABLED(IS_RC_MODE_ACTIVE(BOXMULTISELECT)),     BOXMULTISELECT);    // CR88
