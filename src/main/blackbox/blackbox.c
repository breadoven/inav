...
static const blackboxSimpleFieldDefinition_t blackboxSlowFields[] = {
    ...
    {"activeWpNumber",        -1, UNSIGNED, PREDICT(0),      ENCODING(UNSIGNED_VB)},   // CR112
};
...
static void writeSlowFrame(void)
{
    ...
    blackboxWriteUnsignedVB(slowHistory.activeWpNumber);   // CR112
...
static void loadSlowState(blackboxSlowState_t *slow)
{
    ...
    slow->activeWpNumber = getActiveWpNumber();   // CR112
}
