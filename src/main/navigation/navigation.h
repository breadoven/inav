...
typedef struct navConfig_s {
    ...
    struct {
        struct {
            ...
            uint8_t rth_trackback_mode;         // Useage mode setting for RTH trackback   CR66
        } flags;
        ...
        uint16_t rth_trackback_distance;            // RTH trackback maximum distance [m]  // CR66
    } general;
    ...
    struct {
        ...
        uint16_t waypoint_tracking_deadband; // fixed wing distance deadband to waypoint mission course line    CR67
