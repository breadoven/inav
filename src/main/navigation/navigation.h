...
typedef struct navConfig_s {
    ...
    struct {
        ...
        uint16_t waypoint_tracking_accuracy; // fixed wing tracking accuracy [cm]   CR67
        uint16_t wp_turn_smoothing_dist;     // enables smoother turns during fixed wing waypoint missions [cm]      CR67
    } fw;
} navConfig_t;
